	...
	return (
		<div className="mx-auto flex max-w-screen-lg flex-col gap-8 p-8">
			<div className="flex flex-col gap-4">
				<div>
					NJUST_AI tests each frontier model against{" "}
					<a href="https://github.com/NJUST-AI/NJUST_AI-Evals" className="underline">
				...
				<div>
					...
					<a href="https://discord.gg/njust-ai" className="underline">
						Discord
					</a>
					.
				</div>
