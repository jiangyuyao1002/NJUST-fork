...
async function main() {
	const cliRoot = process.env.NJUST_AI_CLI_ROOT
		? path.resolve(process.env.NJUST_AI_CLI_ROOT)
		: path.resolve(__dirname, "../../..")
	const workspacePath = await fs.mkdtemp(path.join(os.tmpdir(), "njust-ai-cli-create-session-id-"))
