 ...
 *
 * Users can override this with the NjustAi_NERD_FONT environment variable:
 * - NjustAi_NERD_FONT=0 to force ASCII fallbacks (if icons don't render correctly)
 * - NjustAi_NERD_FONT=1 to force Nerd Font icons
 *
...
function detectNerdFontSupport(): boolean {
	...
	const envOverride = process.env.NjustAi_NERD_FONT
	...
	// and users can set NjustAi_NERD_FONT=0 if needed
	return true
}
