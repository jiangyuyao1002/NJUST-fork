...
import type { ModelInfo, ProviderSettings, ReasoningEffortExtended } from "@njust-ai/types"
...
export const getRooReasoning = ({
	...
	// For Njust-AI models that support reasoning effort, absence of a selection should be
	...
	// For Njust-AI, "minimal" is treated as "none" for effort-based reasoning – we omit
