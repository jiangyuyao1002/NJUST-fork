...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "njust_ai_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	njust_ai_read_date: z.number().nullable(),
	njust_ai_edit_date: z.number().nullable(),
