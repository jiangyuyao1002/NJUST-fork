// pnpm --filter njust-ai test core/task-persistence/__tests__/TaskHistoryStore.crossInstance.spec.ts
...
vi.mock("../../../utils/safeWriteJson", () => ({
	safeWriteJson: vi.fn(async function (filePath: string, data: any) {
