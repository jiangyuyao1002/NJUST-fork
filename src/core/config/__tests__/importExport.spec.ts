	...
	describe("exportSettings", () => {
		...
		it("should export settings to the selected file location", async () => {
			;(vscode.window.showSaveDialog as Mock).mockResolvedValue({
				fsPath: "/mock/path/Njust-AI-settings.json",
			})
			...
			expect(safeWriteJson).toHaveBeenCalledWith("/mock/path/Njust-AI-settings.json", {
		...
		it("should use the correct default save location", async () => {
			...
			expect(vscode.Uri.file).toHaveBeenCalledWith(path.join("/mock/home", "Downloads", "Njust-AI-settings.json"))
		})
