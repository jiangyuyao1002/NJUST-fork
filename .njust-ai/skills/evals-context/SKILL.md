...
| **External Exercises Repo** | [NJUST_AI-Evals](https://github.com/NJUST-AI/NJUST_AI-Evals) | Actual coding exercises (NOT in this monorepo)                 |
...
1. Add exercise to [NJUST_AI-Evals](https://github.com/NJUST-AI/NJUST_AI-Evals) repo (external)
...
Edit files in [`apps/web-Njust-AI/src/app/evals/`](apps/web-Njust-AI/src/app/evals/):

- [`evals.tsx`](apps/web-Njust-AI/src/app/evals/evals.tsx) - Display component
- [`plot.tsx`](apps/web-Njust-AI/src/app/evals/plot.tsx) - Charts
...
- Used by both `apps/web-evals` and `apps/web-Njust-AI`
