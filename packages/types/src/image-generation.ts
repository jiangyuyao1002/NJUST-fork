...
export const IMAGE_GENERATION_MODELS: ImageGenerationModel[] = [
	...
	// NJUST_AI Cloud models
	{ value: "google/gemini-2.5-flash-image", label: "Gemini 2.5 Flash Image", provider: "njust-ai" },
	{ value: "google/gemini-3-pro-image", label: "Gemini 3 Pro Image", provider: "njust-ai" },
	{
 ...
 */
export type ImageGenerationProvider = "openrouter" | "njust-ai"
 ...
 * - Otherwise default to "njust-ai" (new users)
 */
export function getImageGenerationProvider(
	explicitProvider: ImageGenerationProvider | undefined,
	hasExistingModel: boolean,
): ImageGenerationProvider {
	return explicitProvider !== undefined ? explicitProvider : hasExistingModel ? "openrouter" : "njust-ai"
}
