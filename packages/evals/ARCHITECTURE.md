...
- **Environment Setup**: Launches VS Code with Njust-AI extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and NJUST_AI extension
