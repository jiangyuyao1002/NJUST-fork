...
export const bedrockModels = {
	...
	"anthropic.claude-sonnet-4-6": {
		...
		supportsPromptCache: true,
		supportsReasoningBudget: true,
		inputPrice: 3.0, // $3 per million input tokens (�?00K context)
		outputPrice: 15.0, // $15 per million output tokens (�?00K context)
	...
	"anthropic.claude-opus-4-6-v1": {
		...
		supportsPromptCache: true,
		supportsReasoningBudget: true,
		inputPrice: 5.0, // $5 per million input tokens (�?00K context)
		outputPrice: 25.0, // $25 per million output tokens (�?00K context)
	...
	"moonshotai.kimi-k2.5": {
		...
		outputPrice: 2.2,
		description:
			"Kimi K2.5 multimodal on Bedrock (moonshotai.kimi-k2.5). Aligns with Moonshot API kimi-k2.5 list pricing.",
	},
	"minimax.minimax-m2": {
		maxTokens: 16_384,
