...
export const internationalZAiModels = {
	...
	"glm-5.1": {
		...
		cacheReadsPrice: 0.11,
		description:
			"GLM-5.1 is Zhipu's latest flagship model with significantly improved coding capabilities and 8-hour sustained autonomous task execution.",
	},
	"glm-5-turbo": {
		maxTokens: 16_384,
		contextWindow: 202_752,
		...
		cacheReadsPrice: 0.11,
		description:
			"GLM-5-Turbo is Zhipu's high-throughput flagship model optimized for agent workloads with 744B parameters and 40B active parameters.",
	},
	"glm-5v-turbo": {
		maxTokens: 16_384,
		contextWindow: 200_000,
		...
		cacheReadsPrice: 0.11,
		description:
			"GLM-5V-Turbo is Zhipu's native multimodal coding model combining visual understanding with programming capabilities for visual-to-code generation.",
	},
	"glm-4.7-flash": {
		maxTokens: 16_384,
		contextWindow: 200_000,
