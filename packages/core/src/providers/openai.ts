...
export const openAiNativeModels = {
	...
	// https://platform.openai.com/docs/models �?flagship pricing Apr 2026
	"gpt-5.5": {
		maxTokens: 128000,
		...
		supportsTemperature: false,
		tiers: [
			{ name: "flex", contextWindow: 1_000_000, inputPrice: 2.5, outputPrice: 15.0, cacheReadsPrice: 0.25 },
			{ name: "priority", contextWindow: 1_000_000, inputPrice: 10.0, outputPrice: 60.0, cacheReadsPrice: 1.0 },
		],
		description: "GPT-5.5: OpenAI flagship model for complex reasoning and coding",
	},
	"gpt-5.4": {
		maxTokens: 128000,
