...
export function resolveOpenAiUsageForCost(args: {
	...
	// If prompt total is smaller than cache rows alone, input is almost certainly non-cached-only �?	// expand so base+discount math stays consistent with OpenAI billing.
