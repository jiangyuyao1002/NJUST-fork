 ...
 *
 * This class manages the state for the marketplace view in the NJUST_AI extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the NJUST_AI extensions interface
...
import { MarketplaceItem, MarketplaceInstalledMetadata } from "@njust-ai/types"
