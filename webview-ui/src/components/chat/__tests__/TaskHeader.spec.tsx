...
// Mock getModelMaxOutputTokens from @shared/api
...
describe("TaskHeader", () => {
	const defaultProps: TaskHeaderProps = {
		task: { id: "task-header-1", type: "say", ts: Date.now(), text: "Test task", images: [] },
		tokensIn: 100,
		tokensOut: 50,
		totalCost: 0.05,
		contextTokens: 200,
	...
	describe("DismissibleUpsell behavior", () => {
		it("does not render legacy DismissibleUpsell block", () => {
			renderTaskHeader()
